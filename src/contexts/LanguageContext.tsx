...
const translations: Record<LanguageCode, any> = {
  es: {
    ...
    lomasLlanadaDetail: {
      ...
      ctaDesc: "Lomas de la Llanada no es solo un proyecto rodeado de naturaleza, sino una inversión dentro de una ciudad que crece con orden, participación comunitaria y enfoque sostenible.",
    },
  },
  en: {
    header: {
